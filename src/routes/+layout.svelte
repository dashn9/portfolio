...
<div class="mx-auto flex max-w-[1180px] flex-col gap-4 px-[clamp(16px,4vw,40px)] pt-4">
	...
	>
		...
		>
			...
			<a href="/cv/DanielShogbon_resume_20250506.pdf" target="_blank" rel="noopener noreferrer" class="block py-px text-paper no-underline hover:text-accent">Résumé ↓</a>
		</div>
